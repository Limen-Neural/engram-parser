...
//! MoE router/expert candidate discovery for Safetensors tensors.
//!
//! Analyzes tensor names and shapes to classify them as routers or experts,
//! group experts by MoE layer, and detect layout families.
...
/// Parsed tensor name for pattern matching.
#[derive(Debug, Clone)]
...
/// Evidence for layout family detection.
...
/// Discover MoE candidates from a set of tensor records.
...
/// Classify a tensor based on its name and shape.
